    ...
    const loadAsyncData = async () => {
        ...
        try {
            ...
            if (location.state.row_data.length == 9) {
                ...
                var plural = plural = location.state.row_data[0].slice(-1) == "s" ? location.state.row_data[0] : location.state.row_data[0] + "s";
                setInfo({
                    ...
                    link: "https://opensea.io/assets/" + type + "?ref=0x5e4c7b1f6ceb2a71efbe772296ab8ab9f4e8582c&search[stringTraits][0][name]=" + location.state.row_data[0] + "&search[stringTraits][0][values][0]=All%20" + plural + "&search[toggles][0]=BUY_NOW&search[sortAscending]=true&search[sortBy]=PRICE",
                })
                ...
                setInfo({
                    ...
                    link: "https://opensea.io/collection/" + location.state.row_data[0] + "?ref=0x5e4c7b1f6ceb2a71efbe772296ab8ab9f4e8582c&collectionSlug=" + location.state.row_data[0] + "&search[sortAscending]=true&search[sortBy]=PRICE&search[toggles][0]=BUY_NOW",
                            ...
                            <div className={classes.details}>
                                <CardContent className={classes.content}>
                                    <Typography variant="h5" component="h5" align='left'>
                                        {location.state.row_data[0][0].toUpperCase() +location.state.row_data[0].substring(1) }
                                    </Typography>
                                    <Typography variant="h5" component="h5" align='left'>
                                    ...
                                    <Grid container justifyContent="flex-start">
                                        <Grid item>
                                            <div class="open-link-continer">
                                                ...
                                                <a class="opensea-link2" href={collection_info.link}></a>
                                            </div>
                                        </Grid>
                                    </Grid>
                                </CardContent>
                            </div>
                            <CardMedia image={image} className={classes.cover} title="NFT COLLECTION IMAGE" />
                        </Card>
                        ...
                        <Card id="prices" className={classes.details_card} elevation={5}>
                            <CardContent >
                                <Grid container justifyContent="space-between">
                                    <Typography inline variant="h5" component="h5" align='left'>Current floor price (ETH):  </Typography>
                                    <Typography inline variant="h5" component="h5" align='right'>{collection_info.floor_price}</Typography>
                                </Grid>

                                <Grid container justifyContent="space-between">
                                    <Typography inline variant="h5" component="h5" align='left'>24H %: </Typography>
                                    <Typography inline variant="h5" component="h5" align='right' style={parseFloat(collection_info.day_change)>0?{color:"#26ad3f"}:{color:"#e04343"}}>{collection_info.day_change}%</Typography>
                                </Grid>

                                <Grid container justifyContent="space-between">
                                    <Typography inline variant="h5" component="h5" align='left'>Current floor cap (ETH):</Typography>
                                    <Typography inline variant="h5" component="h5" align='right'>{numberWithCommas((collection_info.floor_price * collection_info.total_avail).toFixed(2))}</Typography>
                                </Grid>

                                <Grid container justifyContent="space-between">
                                    <Typography inline variant="h5" component="h5" align='left'>Total Minted: </Typography>
                                    <Typography inline variant="h5" component="h5" align='right'>{numberWithCommas(parseInt(collection_info.total_avail))}</Typography>
                                </Grid>

                                <Grid container justifyContent="space-between">
                                    <Typography inline variant="h5" component="h5" align='left'>24H supply %: </Typography>
                                    <Typography variant="h5" component="h5" align='right' style={parseFloat(collection_info.week_change)>0?{color:"#26ad3f"}:{color:"#e04343"}}>{collection_info.week_change}%</Typography>
                                </Grid>

                                <Grid container justifyContent="space-between">
                                    <Typography inline variant="h5" component="h5" align='left'>Current Float %:  </Typography>
                                    <Typography variant="h5" component="h5" align='left'>{collection_info.float}%</Typography>
                                </Grid>
