    ...
    <Grid container >
      ...
      <div id="terms-container">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: District Of Columbia, United
              States
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to niftyprice.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to niftyprice, accessible from{" "}
              <a
                href="http://www.niftyprice.io"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.niftyprice.io
              </a>
            </p>
          </li>
          <li>
